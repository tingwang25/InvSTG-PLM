...
def AddDataArgs(parser):
    ...
    parser.add_argument("--years", default=None, type=str,
                        help="Training year for TrafficStream yearly data.")

    parser.add_argument("--checkyears", default=None, type=str,
                        help="Evaluation year for TrafficStream yearly data.")

    parser.add_argument("--tood", default=1, type=int,
                        help="Whether TrafficStream test set uses checkyears data.")

    parser.add_argument("--sood", default=1, type=int,
                        help="Whether TrafficStream test set keeps year-specific node growth.")
